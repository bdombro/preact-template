...
const _icons = {
	...
	arrowLB: () => import("@slimr/mdi-paths/ArrowLeftBottom"),
	arrowR: () => import("@slimr/mdi-paths/ArrowRight"),
	auth: () => import("@slimr/mdi-paths/ShieldAccountOutline"),
	backspace: () => import("@slimr/mdi-paths/BackspaceOutline"),
	...
	open: () => import("@slimr/mdi-paths/OpenInApp"),
	openInNew: () => import("@slimr/mdi-paths/OpenInNew"),
